...
export async function PUT(request: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const { name, logo_url, description, industry, campaign_types, plan, status, public_enabled, public_description, social_calendar_enabled, ads_calendar_enabled, analysis_enabled, share_token } = body;
    ...
    if (ads_calendar_enabled !== undefined) updates.ads_calendar_enabled = ads_calendar_enabled;
