...
### ✅ CALENDARIO INTERNO (dentro de la app)
...
### ? CALENDARIO P�BLICO (links compartidos /c/[token])

#### 1. **Comentarios mostraban 'usuario' en vez del nombre real**
**Causa:** La API `/api/calendar-links/[token]` obten�a comentarios pero no hac�a JOIN con la tabla `users` para traer informaci�n del autor.

**Soluci�n:** Actualizado en `src/app/api/calendar-links/[token]/route.ts`
- Ahora hace fetch de usuarios despu�s de obtener comentarios
...
#### 2. **?? Edici�n de ideas desde calendario p�blico - TRABAJO FUTURO**
**Estado:** El modal de idea en calendario p�blico es solo lectura actualmente

**Para implementar edici�n completa:**
- Las migraciones 00050 y 00051 ya permiten la edici�n a nivel de permisos RLS
- Falta: Actualizar el modal del calendario p�blico para permitir edici�n
- Estimaci�n: 2-3 horas de desarrollo adicional
